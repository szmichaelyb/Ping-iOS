...
- (void)setupSlideShowSubviewsAndAnimations {
    ...
    [self.slideShow addAnimation:[DRDynamicSlideShowAnimation animationForSubview:self.welcomeLabel page:0 keyPath:@"center" toValue:[NSValue valueWithCGPoint:CGPointMake(self.welcomeLabel.center.x+self.slideShow.frame.size.width, self.welcomeLabel.center.y+self.slideShow.frame.size.height*2)] delay:0.1]];
